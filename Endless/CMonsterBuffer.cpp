#include "global.h"
#include "CMonsterBuffer.h"

#include "CCentral.h"

CMonsterBuffer::CMonsterBuffer()
...
void CMonsterBuffer::Init(const vector<ModelType>& _modelVtx, const vector<UINT>& _modelIdx)
{
...
void CMonsterBuffer::BufferSetting(ID3D11DeviceContext* _deviceContext)
{
	// 정점 버퍼의 단위와 오프셋 설정.
